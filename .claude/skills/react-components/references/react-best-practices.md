...
Don't use raw `useEffect` for data fetching. Use TanStack Query (React Query) which handles caching, race conditions, and loading states. See the `tanstack-query-hooks` skill for patterns.
